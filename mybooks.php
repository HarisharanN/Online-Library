...
echo  '<form method="POST" action="req.php">

<input type="submit"  class="log" value="SEE REQUESTS">
</form>'
?>
<br> <br>

<form action="delete.php">
<input type="submit" value="DELETE A BOOK" class="log">
</form>
<br> <br>
<form action="status.php">
<input type="submit" value="CHANGE STATUS" class="log">
</form>
<br> <br>
<form action="dashboard1.php">
<input type="submit" value="DASHBOARD" class="log">
</form>
