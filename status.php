...
<p class="txts"> STATUS:  <select name="sts"><option>Available</option><option>Not Availabe</option></select></p>
<input type="submit" value="CHANGE" class="log"><br>
</form>'
?>